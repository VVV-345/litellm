...
class GatewayService:
    ...
    async def resolve(self, request: ResolveRequest) -> Resolution:
        ...
        return Resolution(
            ...
            full_log_success_enabled=global_settings.full_log_success_enabled if global_settings else True,
            full_log_sample_percent=global_settings.full_log_sample_percent if global_settings else 100,
            full_log_max_body_kb=global_settings.full_log_max_body_kb if global_settings else 16384,
            full_log_max_storage_mb=global_settings.full_log_max_storage_mb if global_settings else 0,
            log_redact_fields=global_settings.log_redact_fields if global_settings else (),

...
class ChannelRegistry:
    ...
    implementations: Mapping[ChannelKind, CLIProxyAPIChannel | OpenAICompatibleChannel] = MappingProxyType({})
    ...
    def channel(self, kind: ChannelKind) -> CLIProxyAPIChannel | OpenAICompatibleChannel:

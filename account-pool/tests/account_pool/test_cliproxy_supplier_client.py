...
async def test_start_authorization_uses_supplier_endpoint(kind: SupplierKind) -> None:
    ...
    assert paths == [supplier.authorization_path]
...
@pytest.mark.parametrize(
    ("kind", "provider"),
    ((SupplierKind.OPENAI_CODEX, "codex"), (SupplierKind.ANTHROPIC_CLAUDE, "anthropic"), (SupplierKind.GOOGLE_ANTIGRAVITY, "antigravity")),
)

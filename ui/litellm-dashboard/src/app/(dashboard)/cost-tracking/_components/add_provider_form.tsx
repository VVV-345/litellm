        ...
        <FieldGroup>
          <Field>
            <FieldLabel htmlFor={PROVIDER_FIELD_ID}>
              {labelWithHint(t("ui.Provider"), t("ui.Select the LLM provider you want to configure a discount for"))}
            </FieldLabel>
            <Combobox
              items={options}
            ...
            >
              <ComboboxInput id={PROVIDER_FIELD_ID} placeholder={t("ui.Select provider")} className="w-full">
                {selectedOption && (
          ...
          <Field>
            <FieldLabel htmlFor={DISCOUNT_FIELD_ID}>
              {labelWithHint(
                t("ui.Discount Percentage"),
                t("ui.Enter a percentage value (e.g., 5 for 5% discount)"),
              )}
            </FieldLabel>

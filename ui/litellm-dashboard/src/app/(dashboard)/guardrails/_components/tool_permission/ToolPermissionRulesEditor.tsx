        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              {t(
                "ui.Provide regex patterns (e.g., ^mcp__github_.*$) for tool names or types and optionally constrain payload fields.",
              )}
            </p>
          </div>
          {!disabled && (
          ...
          <div>
            <p className="flex items-center gap-1 text-sm font-medium">
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  {t(
                    "ui.Block returns an error when a forbidden tool is invoked. Rewrite strips the tool call but lets the rest of the response continue.",
                  )}
                </TooltipContent>
              </Tooltip>
            </p>

  ...
  return (
    <div className="flex flex-col gap-6 min-w-0 w-full p-4">
      {conversationBlocks.map((block, blockIndex) => {
        ...
        const displayModel = assistantMessage?.model || t("ui.Assistant");
        return (
          <div key={blockIndex} className="space-y-4">
            {block.user && (
              <div className="space-y-2 min-w-0">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-sm font-semibold text-gray-700">{t("ui.You")}</div>
                </div>
            ...
            {assistantMessage ? (
              ...
              <div className="text-sm text-gray-500">{t("ui.Waiting for a response...")}</div>
            )}
          </div>
        );
      })}

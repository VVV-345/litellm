  ...
  return (
    <div className="flex flex-col items-center gap-1 py-6">
      ...
      <div className="text-sm font-medium text-foreground">
        {isFiltered ? t("ui.No matching access groups") : t("ui.No access groups yet")}
      </div>
      <div className="text-sm text-muted-foreground">
        {isFiltered
          ? t("ui.Try a different search term.")
          : t("ui.Create an access group to manage resource permissions for your organization.")}
      </div>
    </div>
  );
}
...
export function AccessGroupsTable({
  ...
  return (
    <DataTable
      ...
      isLoading={isLoading}
      loadingMessage={t("ui.Loading access groups…")}

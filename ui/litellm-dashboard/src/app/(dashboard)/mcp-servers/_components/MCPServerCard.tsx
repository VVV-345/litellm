        ...
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          {oauthFlowUnset && (
            <Tooltip>
              ...
              <TooltipContent>
                {t(
                  "ui.This OAuth server has no flow set (Machine-to-Machine vs Interactive). Open it and choose an OAuth Flow Type so LiteLLM authenticates it as you intend.",
                )}
              </TooltipContent>
            </Tooltip>
          )}
                  ...
                  <TooltipTrigger
                    render={
                      <span className="inline-flex items-center gap-1 font-semibold text-destructive">
                        ...
                        {t("ui.{{count}} user fields missing", { count: missing.length })}
                      </span>
                    }
                  />
                  <TooltipContent>
      ...
      <TooltipContent side="top" className="max-w-xs">
        ...
        {lastCheck && (
          <div className="mb-1 text-xs">
            {t("ui.Last check:")} {new Date(lastCheck).toLocaleString()}
          </div>
        )}
        {error && (

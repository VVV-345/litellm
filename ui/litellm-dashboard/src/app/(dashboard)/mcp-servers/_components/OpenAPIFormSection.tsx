      ...
      <Form.Item
        label={
          <span className="text-sm font-medium text-gray-700 flex items-center">
            ...
            <Tooltip title={t("ui.URL to an OpenAPI specification (JSON or YAML). MCP tools will be automatically generated from the API endpoints defined in the spec.")}>
              <InfoCircleOutlined className="ml-2 text-blue-400 hover:text-blue-600 cursor-help" />
            </Tooltip>
          </span>
        }
        name="spec_path"
        rules={[{ required: true, message: t("ui.Please enter an OpenAPI spec URL") }]}
      >
        <Input

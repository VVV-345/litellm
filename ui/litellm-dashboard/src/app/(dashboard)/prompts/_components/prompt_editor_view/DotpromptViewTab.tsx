...
const DotpromptViewTab: React.FC<DotpromptViewTabProps> = ({ prompt }) => {
  ...
  return (
    <div className="p-6">
      <div className="mb-4">
        <h3 className="text-sm font-medium text-gray-700 mb-2">{t("ui.Generated .prompt file")}</h3>
        <p className="text-xs text-gray-500">{t("ui.This is the dotprompt format that will be saved to the database")}</p>
      </div>

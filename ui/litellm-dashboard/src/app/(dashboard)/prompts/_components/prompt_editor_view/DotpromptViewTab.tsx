...
const DotpromptViewTab: React.FC<DotpromptViewTabProps> = ({ prompt }) => {
  ...
  return (
    <div className="p-6">
      <div className="mb-4">
        <h3 className="text-sm font-medium text-foreground mb-2">{t("ui.Generated .prompt file")}</h3>
        <p className="text-xs text-muted-foreground">
          {t("ui.This is the dotprompt format that will be saved to the database")}
        </p>
      </div>

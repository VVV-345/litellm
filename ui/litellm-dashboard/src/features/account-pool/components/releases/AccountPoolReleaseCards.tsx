...
import type { ReleaseAction, ReleaseVersion, ReleaseView, ReleaseCommands } from "../../api/AccountPoolReleasesApi";
type ReleasePrepare = (action: Omit<ReleaseAction, "revision">, description: string, before?: string) => void;

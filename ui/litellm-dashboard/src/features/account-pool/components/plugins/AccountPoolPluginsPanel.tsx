...
} from "../../utils/AccountPoolPluginRuntime";
...
export function AccountPoolPluginsPanel({
  ...
  const configQueryOptions = {
    queryKey: accountPoolQueryKeys.cardPluginConfig(accessToken, activeCardId, configPluginId),
  ...
  const installedQueryOptions = {
    queryKey: accountPoolQueryKeys.cardPlugins(accessToken, activeCardId),
    queryFn: () => listCardAccountPoolPlugins(accessToken, activeCardId!),
    enabled: activeCardId !== null,
    retry: false,
  } as const;
  const storeQueryOptions = {
    queryKey: accountPoolQueryKeys.cardPluginStore(accessToken, activeCardId),
  ...
  const invalidate = () => {
    void queryClient.invalidateQueries({ queryKey: accountPoolQueryKeys.cardPlugins(accessToken, activeCardId) });
    void queryClient.invalidateQueries({ queryKey: accountPoolQueryKeys.cardPluginStore(accessToken, activeCardId) });
  };

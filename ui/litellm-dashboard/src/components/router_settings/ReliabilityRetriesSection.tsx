  ...
  return (
    <div className="space-y-6">
      <div className="max-w-3xl">
        <h3 className="text-sm font-medium text-foreground">{t("ui.Reliability & Retries")}</h3>
        <p className="text-xs text-muted-foreground mt-1">{t("ui.Configure retry logic and failure handling")}</p>
      </div>

    ...
    <>
      <div className="space-y-6">
        <div className="max-w-3xl">
          <h3 className="text-sm font-medium text-foreground">{t("ui.Latency-Based Configuration")}</h3>
          <p className="text-xs text-muted-foreground mt-1">{t("ui.Fine-tune latency-based routing behavior")}</p>
        </div>
